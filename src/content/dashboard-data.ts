...
export const dashboardData: DashboardSnapshot = {
  ...
  pipelineLog: [
    {
      ts: '2024-07-01 07:00:01',
      level: 'INFO',
      message: 'Pipeline triggered: monthly-statement-ingestion',
    },
    {
      ts: '2024-07-01 07:00:02',
      level: 'INFO',
      message: 'Connecting to statement store (synthetic)...',
    },
    {
      ts: '2024-07-01 07:00:04',
      level: 'INFO',
      message: 'Found 1 new statement: GBM-2024-06.pdf (SYNTHETIC)',
    },
    {
    ...
    },
    {
      ...
      level: 'INFO',
      message: 'Found 34 transactions, 8 unique positions',
    },
    {
      ts: '2024-07-01 07:00:10',
      level: 'INFO',
      message: 'Normalizing tickers to internal schema...',
    },
    {
    ...
    {
      ts: '2024-07-01 07:00:15',
      level: 'INFO',
      message: 'Fetching reference prices (end-of-month close)...',
    },
    ...
    {
      ts: '2024-07-01 07:00:21',
      level: 'INFO',
      message: 'Computing monthly return vs benchmark...',
    },
    {
      ts: '2024-07-01 07:00:23',
      level: 'INFO',
      message: 'Writing normalized holdings to DuckDB (synthetic)...',
    },
    ...
    { ts: '2024-07-01 07:00:31', level: 'INFO', message: 'Exporting dashboard snapshot JSON...' },
    {
      ...
      level: 'INFO',
      message: 'Snapshot written: dashboard_2024-06.json',
    },
