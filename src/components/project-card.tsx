...
export default function ProjectCard({ project, featured = false, href }: ProjectCardProps) {
  return (
    <article
      className="group flex flex-col gap-4 rounded-xl border border-neutral-800 bg-neutral-900 p-6 transition-all hover:border-neutral-700 hover:bg-neutral-800/60"
